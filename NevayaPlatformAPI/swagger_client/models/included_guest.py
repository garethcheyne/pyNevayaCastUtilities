...
class IncludedGuest(object):
    ...
    def __init__(self, locale=None):  # noqa: E501
        """IncludedGuest - a model defined in Swagger"""  # noqa: E501
        self._locale = None
    ...
    @property
    def locale(self):
        """Gets the locale of this IncludedGuest.  # noqa: E501
        ...
        :return: The locale of this IncludedGuest.  # noqa: E501
        :rtype: str
        """
        return self._locale
    ...
    def locale(self, locale):
        """Sets the locale of this IncludedGuest.

        ISO 639-1 language code. Currently the following are supported:  | Code  | Language           | |-------|--------------------| | en    | English (UK)       | | fr    | French             | | es    | Spanish            | | de    | German             | | zh-CN | Simplified Chinese | | en-US | English (US)       | | ar    | Arabic             |  # noqa: E501

        :param locale: The locale of this IncludedGuest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IncludedGuest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IncludedGuest):
            return False
